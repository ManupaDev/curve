  ...
  return (
    <div className="py-16 xl:py-32">
      <div className="px-12 xl:px-72">
        ...
        <p className="mt-8 text-center text-base xl:mt-16 xl:text-3xl">
      ...
      <StartupPricingCards />
      <h1 className="mt-32  px-12  text-lg xl:px-72 xl:text-4xl">Learn more about Start-up Packages and Pricing+</h1>
    </div>
  );
}
