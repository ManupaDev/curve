...
function Service() {
  return (
    <div className="border border-black py-16 px-12 xl:px-72 xl:py-32">
      <h1 className="text-2xl xl:text-5xl underline">Web Development</h1>
      <h1 className="mt-4 xl:mt-8 text-3xl xl:text-6xl underline">Web Build Websites</h1>
      <p className="my-16 text-xs xl:text-2xl xl:my-32">
      ...
      <div className="py-8 grid grid-cols-1 xl:grid-cols-2">
        <div className="py-8">
          <h3 className="text-sm xl:text-2xl">Hello World!</h3>
          <p className="mt-8 text-xs xl:text-xl">
