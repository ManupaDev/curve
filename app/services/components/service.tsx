...
function Service() {
  return (
    <div className="border border-black py-16 px-12 xl:px-72 xl:py-32">
      <h1 className="text-2xl md:text-3xl xl:text-5xl underline">Web Development</h1>
      <h1 className="mt-4 xl:mt-8 text-3xl md:text-4xl xl:text-6xl underline">Web Build Websites</h1>
      ...
      <div className="py-8 grid grid-cols-1 xl:grid-cols-2">
        <div className="py-8">
          <h3 className="text-sm md:text-lg xl:text-2xl">Hello World!</h3>
          <p className="mt-8 text-xs md:text-base xl:text-xl">
