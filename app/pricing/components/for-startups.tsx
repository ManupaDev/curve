  ...
  return (
    <div className="  border-black py-8 xl:py-32">
      <div className="px-12 xl:px-72">
        ...
        <h1 className="mt-16 text-lg xl:mt-32 text-curve-grey-4 xl:text-4xl">
          Want to launch a new digital product? or ready to create a website for your business?
        </h1>
      </div>
      <StartupPricingCards />
      <h1 className="mt-4  text-lg  xl:text-4xl px-12 xl:px-72 text-curve-grey-4">Learn more about Start-up <span className="text-curve-grey-16">Packages and Pricing+</span></h1>
    </div>
  );
}
